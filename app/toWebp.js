...
export default function toWebp() {
    ...
    async function convertToWebp() {
        ...
        const conversion = await manipulateAsync(
            asset.localUri || asset.uri, [], { format: SaveFormat.WEBP }
        );

        setConversion(conversion.uri || conversion.localUri);
    }
        ...
        <>
            <View style={styles.container}>
                <View style={styles.hero}>
                    <Text style={ui.h2}>Convierte tu imagen a WEBP</Text>
